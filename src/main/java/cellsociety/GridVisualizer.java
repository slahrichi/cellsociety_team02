...
public abstract class GridVisualizer {
  ...
  protected int getWidth(){ return this.gridWidth;}
  protected int getHeight(){ return this.gridHeight;}
  protected int getNumRows(){ return this.numRows;}
  protected int getNumColumns(){ return this.numColumns;}
  protected ColorMap getColorMap(){return this.colorMap;}
  protected Grid getGrid(){return this.myGrid;}
